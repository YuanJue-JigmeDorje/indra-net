...
/* type colours -- underline */
.entity-人物   { border-bottom-color: #7eb8da; }
.entity-人物:hover { background: rgba(126,184,218,0.15); }

.entity-圣众   { border-bottom-color: #c9a96e; }
.entity-圣众:hover { background: rgba(201,169,110,0.15); }

.entity-非人   { border-bottom-color: #b05a5a; }
.entity-非人:hover { background: rgba(176,90,90,0.15); }

.entity-寺院   { border-bottom-color: #6ba386; }
.entity-寺院:hover { background: rgba(107,163,134,0.15); }

.entity-地名   { border-bottom-color: #8895a7; }
.entity-地名:hover { background: rgba(136,149,167,0.15); }

.entity-经典   { border-bottom-color: #9a85a8; }
.entity-经典:hover { background: rgba(154,133,168,0.15); }

.entity-教法   { border-bottom-color: #c4956a; }
.entity-教法:hover { background: rgba(196,149,106,0.15); }

.entity-教派   { border-bottom-color: #a09080; }
.entity-教派:hover { background: rgba(160,144,128,0.15); }

.entity-仪轨   { border-bottom-color: #9a9080; }
.entity-仪轨:hover { background: rgba(154,144,128,0.15); }

.entity-法器圣物 { border-bottom-color: #8a8a78; }
.entity-法器圣物:hover { background: rgba(138,138,120,0.15); }
